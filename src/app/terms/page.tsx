  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="prose dark:prose-invert">
        <p>By using Koydo HESI A2 Prep, you agree to these terms.</p>
        <h2>Service Description</h2>
        <p>Koydo provides exam preparation tools including practice questions, mock tests, and AI-powered study aids. This app is an independent study aid and is not affiliated with, endorsed by, or approved by HESI or any official testing authority. All trademarks belong to their respective owners.</p>
        <h2>User Accounts</h2>
