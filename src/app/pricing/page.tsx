...
export const metadata: Metadata = {
  title: "Pricing — Hesi A2 Premium",
  description: "Unlock unlimited Hesi A2 practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=hesi-a2&cadence=annual`;
