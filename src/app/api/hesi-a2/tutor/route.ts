...
const EXAM_ID = "hesi-a2";
const EXAM_DISPLAY_NAME = "HESI A2 (Admission Assessment)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Math, Reading Comprehension, Vocabulary, Grammar, Biology, Chemistry, Anatomy & Physiology, and Physics. Align to Elsevier HESI blueprint.
