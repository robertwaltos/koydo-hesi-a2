...
export const metadata: Metadata = {
  title: "Koydo HESI A2 — Free Exam Prep",
  description: "Comprehensive HESI A2 preparation. Practice tests, AI tutor, score tracking. This app is an independent study aid and is not affiliated with, endorsed by, or approved by HESI or any official testing authority. All trademarks belong to their respective owners.",
};
    ...
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--accent)] to-[var(--accent-dark)] px-4 py-20 text-white">
        <div className="mx-auto max-w-4xl text-center">
          <span className="mb-4 inline-block rounded-full bg-white/20 px-4 py-1.5 text-sm font-medium backdrop-blur">
            Tier 6 · high annual test takers
          </span>
          <h1 className="mb-6 text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            Ace HESI A2 with Koydo
          </h1>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        <h2 className="mb-10 text-center text-2xl font-bold text-zinc-900 dark:text-zinc-100">
          Why Koydo for HESI A2?
        </h2>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            { icon: "📝", title: "Practice Tests", desc: "Hundreds of practice questions matching the real HESI A2 format." },
      ...
      <footer className="border-t border-zinc-200 dark:border-zinc-800 px-4 py-8">
        <p className="mx-auto max-w-3xl text-center text-xs text-zinc-500 dark:text-zinc-500">
          This app is an independent study aid and is not affiliated with, endorsed by, or approved by HESI or any official testing authority. All trademarks belong to their respective owners.
        </p>
